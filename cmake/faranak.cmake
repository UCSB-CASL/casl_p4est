...
if(CMAKE_BUILD_TYPE MATCHES Debug)
    ...
    set(PETSC_DIR /home/faranak/CASL/casl_code_base/external_libraries/petsc_debug)        # PETSc
    set(P4EST_DIR /home/faranak/CASL/casl_code_base/external_libraries/p4est_debug)        # p4est
    set(VORO_DIR  /home/faranak/CASL/casl_code_base/external_libraries/voro_build)         # Voro++

elseif(CMAKE_BUILD_TYPE MATCHES Release)
    message("******* CASL CMAKE IN RELEASE MODE *******")

    set(PETSC_DIR /home/faranak/CASL/casl_code_base/external_libraries/petsc_release)      # PETSc
    set(P4EST_DIR /home/faranak/CASL/casl_code_base/external_libraries/p4est_release)      # p4est
    set(VORO_DIR  /home/faranak/CASL/casl_code_base/external_libraries/voro_build)         # Voro++
...
# MPI.
# Set MPI to MPICH paths
set( MPI_DIR /home/faranak/CASL/casl_code_base/external_libraries/mpich_casl_local_install )
list( APPEND INC_DIRS ${MPI_DIR}/include )
list( APPEND LIB_DIRS ${MPI_DIR}/lib )
list( APPEND LIBS mpi )
...
set( BOOST_DIR /home/faranak/CASL/casl_code_base/external_libraries/boost_build )
