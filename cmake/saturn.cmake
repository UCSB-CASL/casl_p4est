...
if( CMAKE_BUILD_TYPE MATCHES Debug )
	...
	set( PETSC_DIR /home/rgans/Libraries/petsc-3.15.1/build-debug )		# PETSc.
	set( P4EST_DIR /home/rgans/Libraries/p4est-2.3.2/build-debug )		# p4est.
	set( VORO_DIR  /home/rgans/Libraries/voro++-0.4.6/build )		# Voro++.

elseif( CMAKE_BUILD_TYPE MATCHES Release )
	message( "******* CASL CMAKE IN RELEASE MODE *******" )

	set( PETSC_DIR /home/rgans/Libraries/petsc-3.15.1/build-release )	# PETSc.
	set( P4EST_DIR /home/rgans/Libraries/p4est-2.3.2/build-release )	# p4est.
	set( VORO_DIR  /home/rgans/Libraries/voro++-0.4.6/build )		# Voro++
...
set( BOOST_DIR /home/youngmin/boost_1_78_0 )
...
list( APPEND INC_DIRS					# Include directories.
		...
		${MPI_DIR}/include/x86_64-linux-gnu/
		${BOOST_DIR} )
