...
%         comm = load(strcat(folder{k}, '/n_', num2str(p(i)), '/interpolation_log_0_', num2str(it(k,i)-1), '.dat')); postfix='_last_';
        comm = load(strcat(folder{k}, '/n_', num2str(p(i)), '/interpolation_log_0_', num2str(0), '.dat')); postfix='_first_';
...
%         set(h, 'fontsize', fs, 'interpreter', 'latex');
    ...
    export_fig(h1, strcat('host_large_point',   postfix, num2str(p(i)), '.pdf'), '-transparent'); % download from http://www.mathworks.com/matlabcentral/fileexchange/23629-export-fig
    export_fig(h2, strcat('host_large_message', postfix, num2str(p(i)), '.pdf'), '-transparent'); % download from http://www.mathworks.com/matlabcentral/fileexchange/23629-export-fig
    export_fig(h3, strcat('host_large_volume',  postfix, num2str(p(i)), '.pdf'), '-transparent'); % download from http://www.mathworks.com/matlabcentral/fileexchange/23629-export-fig
end