...
inline double gamma_a_0(double x, double y) { return 0.7+0.3;} double_to_cf_t gamma_a_0_cf(&gamma_a_0);
inline double gamma_b_0(double x, double y) { return 0.7-0.4;} double_to_cf_t gamma_b_0_cf(&gamma_b_0);
