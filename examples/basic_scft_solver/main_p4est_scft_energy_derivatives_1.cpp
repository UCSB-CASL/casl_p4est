...
flower_phi_t phi_cf_0(2.2, -0.0, -0.3, 0.2, 1);
//flower_phi_t phi_cf_1(3.8, -2, -4, 0.0, -1);

class phi_cf_1_t : public CF_2
{
public:
  double operator()(double x, double y) const
  {
    return -1.0-y+0.001*x - 0.2*cos(PI*x);
//    return -1.0-x+0.2*cos(PI*y);
  }
} phi_cf_1;
...
inline double gamma_a_1(double x, double y) { return 0.7;} double_to_cf_t gamma_a_1_cf(&gamma_a_1);
inline double gamma_b_1(double x, double y) { return 1.3;} double_to_cf_t gamma_b_1_cf(&gamma_b_1);
