...
flower_phi_t phi_cf_0(2.5, -0.0, -0.3, 0.2, 1);
...
public:
  ...
  {
    return -1.5-y+0.001*x - 0.2*cos(PI*x);
...
inline double gamma_a_1(double x, double y) { return 1.0+2.0*(1.0+y);} double_to_cf_t gamma_a_1_cf(&gamma_a_1);
inline double gamma_b_1(double x, double y) { return 1.0-2.0*(1.0+y);} double_to_cf_t gamma_b_1_cf(&gamma_b_1);
