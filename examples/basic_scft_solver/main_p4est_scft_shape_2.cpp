...
CF_2* phi_cfs[] = {&phi_cf_0, &phi_cf_1, &phi_cf_2};
...
inline double gamma_a_1(double x, double y) { return 1.0-0.3;} double_to_cf_t gamma_a_1_cf(&gamma_a_1);
inline double gamma_b_1(double x, double y) { return 1.0+0.4;} double_to_cf_t gamma_b_1_cf(&gamma_b_1);

inline double gamma_a_2(double x, double y) { return 0.5;} double_to_cf_t gamma_a_2_cf(&gamma_a_1);
inline double gamma_b_2(double x, double y) { return 0.5;} double_to_cf_t gamma_b_2_cf(&gamma_b_1);
...
CF_2* gamma_a_cf[] = {&gamma_a_0_cf, &gamma_a_1_cf, &gamma_a_2_cf};
CF_2* gamma_b_cf[] = {&gamma_b_0_cf, &gamma_b_1_cf, &gamma_b_2_cf};
