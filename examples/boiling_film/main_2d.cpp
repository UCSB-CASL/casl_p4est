...
const double default_T_bottom                     = 5;
...
const double default_domain_to_lambda[P4EST_DIM] = {DIM(1, 1, 1)};
...
const string default_work_folder = "/scratch/regan/two_phase_flow/boiling_film/" + to_string(P4EST_DIM) + "D";
#else
const string default_work_folder = "/home/regan/workspace/projects/two_phase_flow/boiling_film/" + to_string(P4EST_DIM) + "D";
#endif
...
int main (int argc, char* argv[])
{
  ...
  if(cmd.contains("restart"))
  {
    try {
      ...
      ierr = PetscFPrintf(mpi.comm(), stderr, "main for boiling_film: I can't restart properly and safely without 'gravity' and 'T_bottom'. You must give me those."); CHKERRXX(ierr);
      return EXIT_FAILURE;
    }
