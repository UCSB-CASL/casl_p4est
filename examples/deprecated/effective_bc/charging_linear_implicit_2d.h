#ifndef CHARGING_LINEAR_IMPLICIT_2D_H
#define CHARGING_LINEAR_IMPLICIT_2D_H
...
class ImplicitLinearChargingSolver{
  p4est_t* p4est;
  p4est_ghost_t* ghost;
  p4est_nodes_t *nodes;
  ...
  ImplicitLinearChargingSolver(const ImplicitLinearChargingSolver& other);
  ImplicitLinearChargingSolver& operator=(const ImplicitLinearChargingSolver& other);

public:
  ImplicitLinearChargingSolver(p4est_t* p4est_, p4est_ghost_t *ghost_, p4est_nodes_t *nodes_, my_p4est_brick_t *brick_, my_p4est_node_neighbors_t *ngbd_);
  ~ImplicitLinearChargingSolver();
...
#endif // CHARGING_LINEAR_IMPLICIT_2D_H
