% This script solves the effective boundary condition problem in a semi
...
t = 0;
for n=1:4000
    [c,u] = bc_solve_coupled(pde)

    [pde.cn, pde.un] = solve_bulk(c,u,pde);

    figure(1); shg;
    t = t + pde.dt;
    pde.dt = min(1.01*pde.dt, 1e-3);
    subplot(2,2,1);
