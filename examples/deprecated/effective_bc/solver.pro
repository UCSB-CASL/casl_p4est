...
CONFIG(office, stampede|office): {
    ...
    # petsc
    PETSC_INCLUDES_DEBUG = $$PETSC_DIR/debug/include
    PETSC_INCLUDES_RELEASE = $$PETSC_DIR/release/include
    PETSC_LIBS_DEBUG = -Wl,-rpath,$$PETSC_DIR/debug/lib -L$$PETSC_DIR/debug/lib -lpetsc
    PETSC_LIBS_RELEASE = -Wl,-rpath,$$PETSC_DIR/release/lib -L$$PETSC_DIR/release/lib -lpetsc
}
...
CONFIG(profile): {
    TARGET = solver_2d.prof
} else {
    TARGET = solver_2d
}
SOURCES += \
#    solver_2d.cpp\
    charging_linear_implicit_2d.cpp \
    charging_linear_explicit_2d.cpp \
    charging_nonlinear_explicit_2d.cpp \
    solver_linear_2d.cpp \
...
CONFIG(3d, 2d|3d): {
CONFIG(profile):{
        TARGET = solver_3d.prof
} else {
        TARGET = solver_3d
}
SOURCES += \
#    solver_3d.cpp\
    charging_linear_implicit_3d.cpp \
    charging_linear_explicit_3d.cpp \
    charging_nonlinear_explicit_3d.cpp \
    solver_linear_3d.cpp \
