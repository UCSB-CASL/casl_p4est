...
const static std::string main_description = "\
 In this example, we illustrate and test the parCASL library procedures to refine an existing (old) grid to update its \n\
 refinement, creating a (new) grid in the process.                                                                     \n\                                                                                                \n\
 Example of application of interest: Generation of a new grid through adaptive refinement and data transfer from the   \n\
                                     old one.                                                                          \n\
...
int main(int argc, char** argv) {
  ...
  // stopwatch
  parStopWatch w;
  w.start("Running example: grid_update");
