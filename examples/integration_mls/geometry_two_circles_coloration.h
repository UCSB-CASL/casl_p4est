#ifndef GEOMETRY_TWO_CIRCLES_COLORATION_H
#define GEOMETRY_TWO_CIRCLES_COLORATION_H
#include <vector>
...
class geometry_two_circles_coloration_t
{
public:
  ...
  geometry_two_circles_coloration_t()
  {
    double r0 = 0.711;
    double r1 = 0.639;
    double d = 0.35;
    ...
    LSF.push_back(&domain1.phi); action.push_back(COLORATION); color.push_back(1);
    ...
    exact0.ISB.push_back(mu_seg_0);
    exact1.ISB.push_back(mi_seg_0);
