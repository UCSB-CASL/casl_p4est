...
int main (int argc, char* argv[])
{
	try
	{
		...
		flower.getHAndMinVal( N_GRID_POINTS, h, minVal, 12 );	// For flower with a=0.075: M = 129, padding = 5, N_CELLS = 1, yields 263.222 grid points per unit.
		const int N_CELLS = 1;
