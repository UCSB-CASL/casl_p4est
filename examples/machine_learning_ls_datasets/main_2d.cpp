...
#else
/*!
 * Circular signed distance function.
 */
struct circle: CF_2
{
	/*!
	...
	/*!
	 * Signed Distance function evaluation of a point.
...
int main (int argc, char* argv[])
{
	try
	{
		...
		// Create the connectivity object.  Our domain is [0,1]^2.
		p4est_connectivity_t *connectivity;
		my_p4est_brick_t brick;
		int n_xyz[] = {1, 1, 1};                // Number of trees in each direction.
		double xyz_min[] = {0, 0, 0};            // Coordinates of the lower-left-back point.
		...
		// TODO: Here I must create a regular grid, not a quadtree.  Then, evaluate the circular function on the grid.
		...
		ls.reinitialize_2nd_order( phi, 5 );                // TODO: Change here the number of iterations for renitialization.
