...
int main() try
{
	...
	find_min(dlib::lbfgs_search_strategy(10),  // The 10 here is basically a measure of how much memory L-BFGS will use.
	...
	starting_point = {-94, 5.2};
	find_min_using_approximate_derivatives(dlib::lbfgs_search_strategy(10),
										   dlib::objective_delta_stop_strategy(1e-7),
										   rosen, starting_point, -1);
	cout << "rosen solution: \n"<< starting_point << endl;
	...
	starting_point = {0.8, 1.3};
	find_min_trust_region(dlib::objective_delta_stop_strategy(1e-7),
						  rosen_model(),
						  starting_point,
