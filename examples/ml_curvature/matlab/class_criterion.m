...
nonSaddleD = readmatrix("/Volumes/YoungMinEXT/k_ecnet_3d/6/non_saddle_sinusoid_0.csv", "Range", "DE2");
poshk=nonSaddleD(:,1); posihk=nonSaddleD(:,2); posh2kg=nonSaddleD(:,3); posih2kg=nonSaddleD(:,4);
clear nonSaddleD;

saddleD = readmatrix("/Volumes/YoungMinEXT/k_ecnet_3d/6/saddle_sinusoid_0.csv", "Range", "DE2");
