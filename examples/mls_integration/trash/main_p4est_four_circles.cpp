...
#ifdef P4_TO_P8
class LS_CIRCLE_2: public CF_3
{
public:
  double operator()(double x, double y, double z) const
  {
    return (r0 - sqrt(SQR(x-xc_2) + SQR(y-yc_2) + SQR(z-zc_2)));
  }
} ls_circle_2;
#else
class LS_CIRCLE_2: public CF_2
{
public:
  double operator()(double x, double y) const
  {
    return (r0 - sqrt(SQR(x-xc_2) + SQR(y-yc_2)));
  }
} ls_circle_2;
#endif

#ifdef P4_TO_P8
class LS_CIRCLE_3: public CF_3
{
public:
  double operator()(double x, double y, double z) const
  {
    return -(1.2*r0 - sqrt(SQR(x-xc_3) + SQR(y-yc_3) + SQR(z-zc_3)));
  }
} ls_circle_3;
#else
class LS_CIRCLE_3: public CF_2
{
public:
  double operator()(double x, double y) const
  {
    return -(1.2*r0 - sqrt(SQR(x-xc_3) + SQR(y-yc_3)));
  }
} ls_circle_3;
#endif
...
public:
  ...
  Geometry()
  {
    ...
    LSF.push_back(&ls_circle_2); action.push_back(INTERSECTION);  color.push_back(2);
    LSF.push_back(&ls_circle_3); action.push_back(COLORATION);    color.push_back(3);
  }
} geometry;
