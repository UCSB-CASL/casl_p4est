...
PropValue = {markers{I}, 2, 4, 'auto', colors(I,:), 'none'};
...
hold on
plot3(c0s(d,:)/k0./(x>=x_start), c1s(d,:)/k1./(x>=x_start), tf(d,:)./(x>=x_start), 'LineStyle', 'none', 'MarkerSize', 4, 'LineWidth', 2, 'Marker', markers{I}, 'DisplayName', case_name{I}, 'Color', colors(I,:));
hold off
...
hold on
plot(c0s(d,:)/k0./(x>=x_start), c1s(d,:)/k1./(x>=x_start), 'LineStyle', '-', 'MarkerSize', 4, 'LineWidth', 2, 'Marker', markers{I}, 'DisplayName', case_name{I}, 'Color', colors(I,:));
hold off
