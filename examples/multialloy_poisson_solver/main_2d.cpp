...
//    dt = cfl_number*dx/V;
    ...
    bc_t.setWallValues(tm_exact);
    bc_t.setInterfaceType(NOINTERFACE);
    bc_t.setInterfaceValue(tm_exact);
    ...
    sample_cf_on_nodes(p4est, nodes, rhs_tm_cf, rhs_t);
