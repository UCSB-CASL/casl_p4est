...
plot	 "forces_4-6_split_threshold_0.10_cfl_1.00_sl_2.dat" every ::7457 using 1:2 title '$C_{\mathrm{D}, x}$' with lines lw 3,\
	 "forces_4-6_split_threshold_0.10_cfl_1.00_sl_2.dat" every ::7457 using 1:3 title '$C_{\mathrm{D}, y}$' with lines lw 3
