...
if (plot_detailed_convergence == 1)
    ...
    % legend
    L = legend('Sym', 'NS 1', 'NS 2', 'NS 3', 'Sym (max)', 'NS 1 (max)', 'NS 2 (max)', 'NS 3 (max)');
...
if (plot_condensed_convergence == 1)
    ...
    L = loglog(h, n_error_sl_max_a); set(L, PropName, PropValue); set(L, 'Marker', 's');
    L = loglog(h, n_error_sl_max_b); set(L, PropName, PropValue); set(L, 'Marker', 'd');
    L = loglog(h, n_error_sl_max_c); set(L, PropName, PropValue); set(L, 'Marker', '*');
    ...
    % legend
    L = legend('Sym', 'NS 1', 'NS 2', 'NS 3', '2nd order');
    set(L, 'interpreter', 'latex');
    ...
    L = loglog(h, n_error_gr_max_a); set(L, PropName, PropValue); set(L, 'Marker', 's');
    L = loglog(h, n_error_gr_max_b); set(L, PropName, PropValue); set(L, 'Marker', 'd');
    L = loglog(h, n_error_gr_max_c); set(L, PropName, PropValue); set(L, 'Marker', '*');
    ...
    % legend
    L = legend('Sym', 'NS 1', 'NS 2', 'NS 3', '1st order', '2nd order');
    set(L, 'interpreter', 'latex');
