#ifndef PROBEM_CASE_3_H
#define PROBEM_CASE_3_H
#include <vector>
...
//          return 1;
  ...
  problem_case_3_t()
  {
    ...
    phi_cf.push_back(&domain1.phi); action.push_back(MLS_COLORATION); color.push_back(1);
