...
public:
  ...
  class bc_coeff_3_t : public CF_2 {
  public:
      double operator()(double x, double y) const
      {
          return exp(x+y);
  ...
  problem_case_4_t()
  {
    ...
    double r3 = 0.66, xc3 = 0.41, yc3 = 0.79, zc3 = 0.42, nx3 = 1.0, ny3 = 1.0, nz3 = 1.0, theta3 =-0.0*PI, beta3 =-0.08, inside3 = 1;
    ...
    domain3.set_params(r3, xc3, yc3, zc3, beta3, inside3, nx3, ny3, nz3, theta3);
#else
    ...
    double r3 = 0.66, xc3 = 0.41, yc3 = 0.79, theta3 =-0.0*PI, beta3 =-0.08, inside3 = 1;
    ...
    domain3.set_params(r3, xc3, yc3, beta3, inside3, theta3);
#endif

    phi_cf.push_back(&domain0.phi); action.push_back(MLS_INTERSECTION); color.push_back(0);
    phi_cf.push_back(&domain3.phi); action.push_back(MLS_COLORATION); color.push_back(1);
    phi_cf.push_back(&domain1.phi); action.push_back(MLS_ADDITION); color.push_back(2);
    phi_cf.push_back(&domain2.phi); action.push_back(MLS_INTERSECTION); color.push_back(3);
