...
public:
  ...
  problem_case_4_t()
  {
    ...
    phi_cf.push_back(&domain3.phi); action.push_back(COLORATION); color.push_back(1);
    phi_cf.push_back(&domain1.phi); action.push_back(ADDITION); color.push_back(2);
    phi_cf.push_back(&domain2.phi); action.push_back(INTERSECTION); color.push_back(3);
