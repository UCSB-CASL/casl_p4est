...
# show color bar/color legend
warpByScalar2Display.SetScalarBarVisibility(renderView2, True)
...
# show color bar/color legend
warpByScalar3Display.SetScalarBarVisibility(renderView2, True)
...
# show color bar/color legend
threshold1Display_2.SetScalarBarVisibility(renderView3, True)
...
# show color bar/color legend
warpByScalar4Display.SetScalarBarVisibility(renderView3, True)
...
# show color bar/color legend
warpByScalar5Display.SetScalarBarVisibility(renderView3, True)
...
# show color bar/color legend
warpByScalar6Display.SetScalarBarVisibility(renderView3, True)
