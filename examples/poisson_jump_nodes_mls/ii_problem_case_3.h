#ifndef II_PROBEM_CASE_3_H
#define II_PROBEM_CASE_3_H
#include <vector>
...
//          return 1;
  ...
  ii_problem_case_3_t()
  {
    ...
    phi_cf.push_back(&domain1.phi); action.push_back(COLORATION); color.push_back(1);
