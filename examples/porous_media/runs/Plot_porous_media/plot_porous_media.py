...
data = pd.read_csv("/home/elyce/CASL/casl_code_base/casl_p4est/examples/porous_media/runs/Plot_porous_media/test_file_for_plot_porous_media_python.csv") # CHANGE IT TO YOUR FOLDER - CHANGE 'elyce' TO THE NAME OF YOUR COMPUTER
