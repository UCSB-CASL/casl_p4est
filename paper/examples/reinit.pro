...
CONFIG(2d, 2d|3d): {
CONFIG(profile): {
    TARGET = reinitialization_2d.prof
} else {
    TARGET = reinitialization_2d
}
SOURCES += \
    main_reinitialization_2d.cpp\
...
CONFIG(3d, 2d|3d): {
CONFIG(profile):{
    TARGET = reinitialization_3d.prof
} else {
    TARGET = reinitialization_3d
}
SOURCES += \
    main_reinitialization_3d.cpp\
