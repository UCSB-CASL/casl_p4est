...
\begin{figure}[htbp]
	\begin{center}
		\subfigure[$N_G = 33$M, $\alpha = 5\%$]{\includegraphics[width = 0.48 \textwidth] {figures/host_Interpolation_small_alpha_5.pdf}}
		\subfigure[$N_G = 33$M, $\alpha = 95\%$]{\includegraphics[width = 0.48 \textwidth] {figures/host_Interpolation_small_alpha_95.pdf}}
		\\
		\subfigure[$N_G = 280$M, $\alpha = 5\%$]{\includegraphics[width = 0.48 \textwidth] {figures/host_Interpolation_large_alpha_5.pdf}}
		\subfigure[$N_G = 280$M, $\alpha = 95\%$]{\includegraphics[width = 0.48 \textwidth] {figures/host_Interpolation_large_alpha_95.pdf}}
	\end{center}
