...
CONFIG(debug, debug|release): {
    INCLUDEPATH += $$P4EST_INCLUDES_DEBUG $$PETSC_INCLUDES_DEBUG $$VORO_INCLUDES_DEBUG
    LIBS += $$P4EST_LIBS_DEBUG $$PETSC_LIBS_DEBUG $$VORO_LIBS_DEBUG
    DEFINES += DEBUG CASL_THROWS P4EST_DEBUG
}

CONFIG(release, debug|release): {
    INCLUDEPATH += $$P4EST_INCLUDES_RELEASE $$PETSC_INCLUDES_RELEASE $$VORO_INCLUDES_RELEASE
    LIBS += $$P4EST_LIBS_RELEASE $$PETSC_LIBS_RELEASE $$VORO_LIBS_RELEASE
}
