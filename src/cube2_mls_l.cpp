...
void cube2_mls_l_t::construct_domain(std::vector<CF_2 *> &phi, std::vector<action_t> &acn, std::vector<int> &clr)
{
...
double cube2_mls_l_t::integrate_over_domain(CF_2 &f)
{
  switch (loc){
    case INS:
      {
...
double cube2_mls_l_t::integrate_over_interface(CF_2 &f, int num)
{
  if (loc == FCE)
  {
...
double cube2_mls_l_t::integrate_over_colored_interface(CF_2 &f, int num0, int num1)
{
  if (loc == FCE)
  {
...
double cube2_mls_l_t::integrate_over_intersection(CF_2 &f, int num0, int num1)
{
...
double cube2_mls_l_t::integrate_in_dir(CF_2 &f, int dir)
{
  switch (loc){
    case INS:
      {
...
//double cube2_mls_l_t::measure_of_domain()
//{
//  switch (loc){
//  case INS:
//  {
...
//double cube2_mls_l_t::measure_of_interface(int num)
//{
//  if (loc == FCE)
//  {
...
//double cube2_mls_l_t::measure_of_colored_interface(int num0, int num1)
//{
//  if (loc == FCE)
//  {
...
//double cube2_mls_l_t::measure_of_intersection(int num0, int num1)
//{
...
//double cube2_mls_l_t::measure_in_dir(int dir)
//{
//  switch (loc){
//  case INS:
//  {
...
//double cube2_mls_l_t::integrate_in_non_cart_dir(double *f, int dir)
//{
//  if (loc == FCE)
//  {
//    double F[4];
...
//double cube2_mls_l_t::interpolate_linear(double *f, double x, double y)
//{
...
//double cube2_mls_l_t::interpolate_quadratic(double *f, double *fxx, double *fyy, double x, double y)
//{
//  double d_m00 = (x-x0)/(x1-x0);
//  double d_p00 = (x1-x)/(x1-x0);
//  double d_0m0 = (y-y0)/(y1-y0);
