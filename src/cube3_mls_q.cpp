...
void cube3_mls_q_t::construct_domain(std::vector<CF_3 *> &phi, std::vector<action_t> &acn, std::vector<int> &clr)
{
...
double cube3_mls_q_t::integrate_over_domain(CF_3 &f)
{
//  return 0;
  switch (loc){
    case INS:
...
double cube3_mls_q_t::integrate_over_interface(CF_3& f, int num)
{
//  return 0;
  if (loc == FCE)
  {
...
double cube3_mls_q_t::integrate_over_colored_interface(CF_3 &f, int num0, int num1)
{
  if (loc == FCE)
  {
...
double cube3_mls_q_t::integrate_over_intersection(CF_3 &f, int num0, int num1)
{
...
double cube3_mls_q_t::integrate_over_intersection(CF_3 &f, int num0, int num1, int num2)
{
...
double cube3_mls_q_t::integrate_in_dir(CF_3 &f, int dir)
{
  switch (loc){
    case OUT: return 0;
    case INS:
...
//void cube3_mls_q_t::interpolate_to_cube(double *in, double *out)
//{
...
double cube3_mls_q_t::interpolate_quad(std::vector<double> f, double X, double Y, double Z)
{
...
//double cube3_mls_q_t::measure_of_domain()
//{
//  switch (loc){
//    case INS:
//      {
...
//double cube3_mls_q_t::measure_of_interface(int num)
//{
//  if (loc == FCE)
//  {
//    std::vector<double> F(n_nodes_simplex, 1);
...
//double cube3_mls_q_t::measure_of_colored_interface(int num0, int num1)
//{
//  if (loc == FCE)
//  {
//    std::vector<double> F(n_nodes_simplex, 1);
...
//double cube3_mls_q_t::measure_of_intersection(int num0, int num1)
//{
//  if (loc == FCE && num_of_lsfs > 1)
//  {
//    std::vector<double> F(n_nodes_simplex, 1);
...
//double cube3_mls_q_t::measure_in_dir(int dir)
//{
//  switch (loc){
//    case OUT: return 0;
//    case INS:
...
//double cube3_mls_q_t::interpolate_linear(double *f, double x, double y, double z)
//{
//  double eps = 1.e-12;
...
//double cube3_mls_q_t::interpolate_quadratic(double *f, double *fxx, double *fyy, double *fzz, double x, double y, double z)
//{
//  double eps = 1.e-12;
