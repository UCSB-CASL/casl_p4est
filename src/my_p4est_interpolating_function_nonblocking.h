#ifndef INTERPOLATING_FUNCTION_NONBLOCKING_H
#define INTERPOLATING_FUNCTION_NONBLOCKING_H
...
#ifdef P4_TO_P8
class InterpolatingFunctionNodeBaseNonblocking: public CF_3
#else
class InterpolatingFunctionNodeBaseNonblocking: public CF_2
#endif
{
  ...
  InterpolatingFunctionNodeBaseNonblocking(const InterpolatingFunctionNodeBaseNonblocking& other);
  InterpolatingFunctionNodeBaseNonblocking& operator=(const InterpolatingFunctionNodeBaseNonblocking& other);
public:
  InterpolatingFunctionNodeBaseNonblocking(Vec F, const my_p4est_node_neighbors_t& neighbors, interpolation_method method = linear);
#ifdef P4_TO_P8  
  InterpolatingFunctionNodeBaseNonblocking(Vec F, Vec Fxx, Vec Fyy, Vec Fzz, const my_p4est_node_neighbors_t& neighbors, interpolation_method method = quadratic_non_oscillatory);
#else
  InterpolatingFunctionNodeBaseNonblocking(Vec F, Vec Fxx, Vec Fyy, const my_p4est_node_neighbors_t& neighbors, interpolation_method method = quadratic_non_oscillatory);
#endif  
  ~InterpolatingFunctionNodeBaseNonblocking();
...
#endif // INTERPOLATING_FUNCTION_NONBLOCKING_H
