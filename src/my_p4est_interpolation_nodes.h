...
private:
  ...
  void set_input(Vec *F, Vec *Fxxyyzz_block_, Vec *Fxx_, Vec *Fyy_,
                 ...
                 Vec *Fzz_,
               #endif
                 interpolation_method method, unsigned int n_vecs_);
...
public:
  ...
  void set_input(Vec F, Vec Fxx_, Vec Fyy_,
               #ifdef P4_TO_P8
                 Vec Fzz_,
               #endif
                 interpolation_method method)
  ...
  void set_input(vector<Vec> Fs, vector<Vec> Fxxs, vector<Vec> Fyys,
               #ifdef P4_TO_P8
                 vector<Vec> Fzzs,
               #endif
                 interpolation_method method)
  ...
  void set_input(Vec *F, Vec *Fxx_, Vec *Fyy_,
                 ...
                 interpolation_method method, unsigned int n_vecs_)
  {
    set_input(F, NULL, Fxx_, Fyy_, method, n_vecs_);
  }
  // -----------------------------------------------------------------------------

  // ----- setting inputs with P4EST_DIM-block structured second derivatives -----
  void set_input(Vec F, Vec Fxxyyzz_block_, interpolation_method method)
  {
  ...
  void set_input(vector<Vec> Fs, vector<Vec> Fxxyyzz_blocks, interpolation_method method)
  {
  ...
  void set_input(Vec *F, Vec *Fxxyyzz_blocks_, interpolation_method method, unsigned int n_vecs_)
  {
