...
public:
   ...
   */
#ifdef P4_TO_P8
  double advect_in_normal_direction(const CF_3& vn, Vec phi, double dt_max = DBL_MAX, Vec phi_xx = NULL, Vec phi_yy = NULL, Vec phi_zz = NULL);
#else
  double advect_in_normal_direction(const CF_2& vn, Vec phi, double dt_max = DBL_MAX, Vec phi_xx = NULL, Vec phi_yy = NULL);
#endif
