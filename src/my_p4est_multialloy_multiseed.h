#ifndef MY_P4EST_MULTIALLOY_MULTISEED_H
#define MY_P4EST_MULTIALLOY_MULTISEED_H
...
#include <src/my_p8est_poisson_nodes_multialloy_multiseed.h>
...
#include <src/my_p4est_poisson_nodes_multialloy_multiseed.h>
...
//    ierr = VecRestoreArray(c0n_n_, &c0n_n_p); CHKERRXX(ierr);
  ...
  inline void set_seeds(int num_seeds, std::vector<Vec> &phi_seed, double *theta_seed)
  {
    num_seeds_ = num_seeds;
    phi_seed_ = phi_seed;
    theta_seed_ = theta_seed;
  }
...
#endif /* MY_P4EST_MULTIALLOY_MULTISEED_H */
