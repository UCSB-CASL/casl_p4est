...
void my_p4est_node_neighbors_t::init_neighbors()
{
    ...
    oss2Debug << this->convert2FullPath("forest_of_neighbor_quads")<<"_"<<myRank<<".txt";
    ...
    for( p4est_locidx_t n=0; n < nodes->num_owned_indeps; ++n)
    {
        ...
        bool ghost_mmm=true,ghost_mpm=true,ghost_pmm=true,ghost_ppm=true;
        ...
        p4est_tree_t *tree_mmm_idx2 = (p4est_tree_t*)sc_array_index(p4est->trees, tree_mmm_idx);
        int my_tree_first_number_tree_mmm_idx=tree_mmm_idx2->quadrants_offset;


        p4est_tree_t *tree_mpm_idx2 = (p4est_tree_t*)sc_array_index(p4est->trees, tree_mpm_idx);
        int my_tree_first_number_tree_mpm_idx=tree_mpm_idx2->quadrants_offset;

        p4est_tree_t *tree_pmm_idx2 = (p4est_tree_t*)sc_array_index(p4est->trees, tree_pmm_idx);
        int my_tree_first_number_tree_pmm_idx=tree_pmm_idx2->quadrants_offset;

        p4est_tree_t *tree_ppm_idx2 = (p4est_tree_t*)sc_array_index(p4est->trees, tree_ppm_idx);
        int my_tree_first_number_tree_ppm_idx=tree_ppm_idx2->quadrants_offset;


        //    fprintf(outFile,"%d %d %d %d %d %d %d\n",myRank, n,n+global_node_number,
        //            quad_mmm_idx+myFirstNumber+my_tree_first_number_tree_mmm_idx,
        //            quad_mpm_idx+myFirstNumber+my_tree_first_number_tree_mpm_idx,
        //            quad_pmm_idx+myFirstNumber+my_tree_first_number_tree_pmm_idx,
        //            quad_ppm_idx+myFirstNumber+my_tree_first_number_tree_ppm_idx);

        //    fprintf(outFile,"%d %d %d %d %d %d %d\n",myRank, n,n+global_node_number,
        //            quad_mmm_idx+myFirstNumber,
        //            quad_mpm_idx+myFirstNumber,
        //            quad_pmm_idx+myFirstNumber,
        //            quad_ppm_idx+myFirstNumber);
        ...
        int myFirstNumber_mmm_idx=-1;
        int myFirstNumber_mpm_idx=-1;
        int myFirstNumber_pmm_idx=-1;
        int myFirstNumber_ppm_idx=-1;




        neighbors[n].nodes = nodes;
        neighbors[n].node_000 = n;
...
#endif
        {
            ...
            neighbors[n].d_m00 = P4EST_QUADRANT_LEN(quad_m00->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_m00_mm = nodes->local_nodes[P4EST_CHILDREN*quad_m00_idx + dir::v_mmm];
            neighbors[n].node_m00_pm = nodes->local_nodes[P4EST_CHILDREN*quad_m00_idx + dir::v_mpm];
#ifdef P4_TO_P8
            neighbors[n].node_m00_mp = nodes->local_nodes[P4EST_CHILDREN*quad_m00_idx + dir::v_mmp];
            neighbors[n].node_m00_pp = nodes->local_nodes[P4EST_CHILDREN*quad_m00_idx + dir::v_mpp];
#endif
            ...
            neighbors[n].d_m00_m0 = y - qy;
            neighbors[n].d_m00_p0 = qh - neighbors[n].d_m00_m0;
#ifdef P4_TO_P8
            neighbors[n].d_m00_0m = z - qz;
            neighbors[n].d_m00_0p = qh - neighbors[n].d_m00_0m;
#endif
        }
...
#endif
        {
            ...
            neighbors[n].d_p00 = P4EST_QUADRANT_LEN(quad_p00->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_p00_mm = nodes->local_nodes[P4EST_CHILDREN*quad_p00_idx + dir::v_pmm];
            neighbors[n].node_p00_pm = nodes->local_nodes[P4EST_CHILDREN*quad_p00_idx + dir::v_ppm];
#ifdef P4_TO_P8
            neighbors[n].node_p00_mp = nodes->local_nodes[P4EST_CHILDREN*quad_p00_idx + dir::v_pmp];
            neighbors[n].node_p00_pp = nodes->local_nodes[P4EST_CHILDREN*quad_p00_idx + dir::v_ppp];
#endif
            ...
            neighbors[n].d_p00_m0 = y - qy;
            neighbors[n].d_p00_p0 = qh - neighbors[n].d_p00_m0;
#ifdef P4_TO_P8
            neighbors[n].d_p00_0m = z - qz;
            neighbors[n].d_p00_0p = qh - neighbors[n].d_p00_0m;
#endif
        }
...
#endif
        {
            ...
            neighbors[n].d_0m0 = P4EST_QUADRANT_LEN(quad_0m0->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_0m0_mm = nodes->local_nodes[P4EST_CHILDREN*quad_0m0_idx + dir::v_mmm];
            neighbors[n].node_0m0_pm = nodes->local_nodes[P4EST_CHILDREN*quad_0m0_idx + dir::v_pmm];
#ifdef P4_TO_P8
            neighbors[n].node_0m0_mp = nodes->local_nodes[P4EST_CHILDREN*quad_0m0_idx + dir::v_mmp];
            neighbors[n].node_0m0_pp = nodes->local_nodes[P4EST_CHILDREN*quad_0m0_idx + dir::v_pmp];
#endif
            ...
            neighbors[n].d_0m0_m0 = x - qx;
            neighbors[n].d_0m0_p0 = qh - neighbors[n].d_0m0_m0;
#ifdef P4_TO_P8
            neighbors[n].d_0m0_0m = z - qz;
            neighbors[n].d_0m0_0p = qh - neighbors[n].d_0m0_0m;
#endif
        }
...
#endif
        {
            ...
            neighbors[n].d_0p0 = P4EST_QUADRANT_LEN(quad_0p0->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_0p0_mm = nodes->local_nodes[P4EST_CHILDREN*quad_0p0_idx + dir::v_mpm];
            neighbors[n].node_0p0_pm = nodes->local_nodes[P4EST_CHILDREN*quad_0p0_idx + dir::v_ppm];
#ifdef P4_TO_P8
            neighbors[n].node_0p0_mp = nodes->local_nodes[P4EST_CHILDREN*quad_0p0_idx + dir::v_mpp];
            neighbors[n].node_0p0_pp = nodes->local_nodes[P4EST_CHILDREN*quad_0p0_idx + dir::v_ppp];
#endif
            ...
            neighbors[n].d_0p0_m0 = x - qx;
            neighbors[n].d_0p0_p0 = qh - neighbors[n].d_0p0_m0;
#ifdef P4_TO_P8
            neighbors[n].d_0p0_0m = z - qz;
            neighbors[n].d_0p0_0p = qh - neighbors[n].d_0p0_0m;
#endif
        }
        ...
        if(quad_mmm!=&root || quad_pmm!=&root || quad_mpm!=&root || quad_ppm!=&root)
        {
            ...
            neighbors[n].d_00m = P4EST_QUADRANT_LEN(quad_00m->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_00m_mm = nodes->local_nodes[P4EST_CHILDREN*quad_00m_idx + dir::v_mmm];
            neighbors[n].node_00m_pm = nodes->local_nodes[P4EST_CHILDREN*quad_00m_idx + dir::v_pmm];
            neighbors[n].node_00m_mp = nodes->local_nodes[P4EST_CHILDREN*quad_00m_idx + dir::v_mpm];
            neighbors[n].node_00m_pp = nodes->local_nodes[P4EST_CHILDREN*quad_00m_idx + dir::v_ppm];
            ...
            neighbors[n].d_00m_m0 = x - qx;
            neighbors[n].d_00m_p0 = qh - neighbors[n].d_00m_m0;
            neighbors[n].d_00m_0m = y - qy;
            neighbors[n].d_00m_0p = qh - neighbors[n].d_00m_0m;
        }
        ...
        if(quad_mmp!=&root || quad_pmp!=&root || quad_mpp!=&root || quad_ppp!=&root)
        {
            ...
            neighbors[n].d_00p = P4EST_QUADRANT_LEN(quad_00p->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_00p_mm = nodes->local_nodes[P4EST_CHILDREN*quad_00p_idx + dir::v_mmp];
            neighbors[n].node_00p_pm = nodes->local_nodes[P4EST_CHILDREN*quad_00p_idx + dir::v_pmp];
            neighbors[n].node_00p_mp = nodes->local_nodes[P4EST_CHILDREN*quad_00p_idx + dir::v_mpp];
            neighbors[n].node_00p_pp = nodes->local_nodes[P4EST_CHILDREN*quad_00p_idx + dir::v_ppp];
            ...
            neighbors[n].d_00p_m0 = x - qx;
            neighbors[n].d_00p_p0 = qh - neighbors[n].d_00p_m0;
            neighbors[n].d_00p_0m = y - qy;
            neighbors[n].d_00p_0p = qh - neighbors[n].d_00p_0m;
        }
#endif
       ...
       */
            ...
            neighbors[n].d_m00 = - neighbors[n].d_p00 - P4EST_QUADRANT_LEN(quad_tmp->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_m00_mm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_pmm];
            neighbors[n].node_m00_pm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_ppm];
#ifdef P4_TO_P8
            neighbors[n].node_m00_mp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_pmp];
            neighbors[n].node_m00_pp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_ppp];
#endif
...
#endif
        {
            ...
            neighbors[n].d_p00 = - neighbors[n].d_m00 - P4EST_QUADRANT_LEN(quad_tmp->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_p00_mm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mmm];
            neighbors[n].node_p00_pm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mpm];
#ifdef P4_TO_P8
            neighbors[n].node_p00_mp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mmp];
            neighbors[n].node_p00_pp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mpp];
#endif
...
#endif
        {
            ...
            neighbors[n].d_0m0 = - neighbors[n].d_0p0 - P4EST_QUADRANT_LEN(quad_tmp->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_0m0_mm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mpm];
            neighbors[n].node_0m0_pm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_ppm];
#ifdef P4_TO_P8
            neighbors[n].node_0m0_mp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mpp];
            neighbors[n].node_0m0_pp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_ppp];
#endif
...
#endif
        {
            ...
            neighbors[n].d_0p0 = - neighbors[n].d_0m0 - P4EST_QUADRANT_LEN(quad_tmp->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_0p0_mm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mmm];
            neighbors[n].node_0p0_pm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_pmm];
#ifdef P4_TO_P8
            neighbors[n].node_0p0_mp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mmp];
            neighbors[n].node_0p0_pp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_pmp];
#endif
        ...
        if(quad_mmm==&root && quad_pmm==&root && quad_mpm==&root && quad_ppm==&root)
        {
            ...
            neighbors[n].d_00m = - neighbors[n].d_00p - P4EST_QUADRANT_LEN(quad_tmp->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_00m_mm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mmp];
            neighbors[n].node_00m_pm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_pmp];
            neighbors[n].node_00m_mp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mpp];
            neighbors[n].node_00m_pp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_ppp];
        ...
        if(quad_mmp==&root && quad_pmp==&root && quad_mpp==&root && quad_ppp==&root)
        {
            ...
            neighbors[n].d_00p = - neighbors[n].d_00m - P4EST_QUADRANT_LEN(quad_tmp->level) / (double) P4EST_ROOT_LEN;
            neighbors[n].node_00p_mm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mmm];
            neighbors[n].node_00p_pm = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_pmm];
            neighbors[n].node_00p_mp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_mpm];
            neighbors[n].node_00p_pp = nodes->local_nodes[P4EST_CHILDREN*quad_tmp_idx + dir::v_ppm];
...
void my_p4est_node_neighbors_t::init_neighbors_with_periodicities()
{
    int myRank;
    MPI_Comm_rank(MPI_COMM_WORLD, &myRank);
...
//        if(!ghost_mmm)
//            myFirstNumber_mmm_idx=this->p4est->global_first_quadrant[myRank];
//        else
//            myFirstNumber_mmm_idx=this->p4est->global_first_quadrant[quad_mmm->p.piggy1.owner_rank];

//        if(!ghost_mpm)
//            myFirstNumber_mpm_idx=this->p4est->global_first_quadrant[myRank];
//        else
//            myFirstNumber_mpm_idx=this->p4est->global_first_quadrant[quad_mpm->p.piggy1.owner_rank];

//        if(!ghost_pmm)
//            myFirstNumber_pmm_idx=this->p4est->global_first_quadrant[myRank];
//        else
//            myFirstNumber_pmm_idx=this->p4est->global_first_quadrant[quad_pmm->p.piggy1.owner_rank];

//        if(!ghost_ppm)
//            myFirstNumber_ppm_idx=this->p4est->global_first_quadrant[myRank];
//        else
//            myFirstNumber_ppm_idx=this->p4est->global_first_quadrant[quad_ppm->p.piggy1.owner_rank];


//        fprintf(outFile,"%d %d %d %d %d %d %d %d %d %d %d\n",myRank, n,n+global_node_number,
//                quad_mmm_idx,myFirstNumber_mmm_idx,
//                quad_mpm_idx,myFirstNumber_mpm_idx,
//                quad_pmm_idx,myFirstNumber_pmm_idx,
//                quad_ppm_idx,myFirstNumber_ppm_idx);
       ...
       */
       ...
       // std::cout<<" correcting for periodicities "<<std::endl;
        //   correcting for periodicities
...

        {
            ...
            if(this->px)
            {
                //------------------------------------0m0--------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_mmm_0m0 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_0m0_idx + 0];
                    double tree_xmin_0m0 = connectivity->vertices[3*v_mmm_0m0 + 0];
                    ...
                    // debugging code
                    double qx_0m0 = quad_0m0->x / (double) P4EST_ROOT_LEN + tree_xmin_0m0;
                    double qh_0m0=P4EST_QUADRANT_LEN(quad_0m0->level) / (double) P4EST_ROOT_LEN;
                    double d_0m0_p0=qx_0m0+qh_0m0-x;
                    double d_0m0_m0=x-qx_0m0;

                    bool p1_0m0=d_0m0_p0==this->max_distance;
                    bool p2_0m0=d_0m0_m0==this->max_distance;
                    if(x<quad_0m0->x / (double) P4EST_ROOT_LEN + tree_xmin_0m0)
                    {
                        this->neighbors[n].d_0m0_m0 += (double)this->max_distance;
                    }


                    //d0m0_p0
                    if(quad_0m0->x / (double) P4EST_ROOT_LEN + tree_xmin_0m0+P4EST_QUADRANT_LEN(quad_0m0->level) / (double) P4EST_ROOT_LEN-x==this->max_distance)
                    {
                        this->neighbors[n].d_0m0_p0 = 0;
                    }

                    if(this->neighbors[n].d_0m0_p0==this->max_distance)
                    {
                        this->neighbors[n].d_0m0_p0 = 0;
                    }
                ...
                //---------------------------0p0----------------------------------------//
                {
                    p4est_topidx_t v_mmm_0p0 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_0p0_idx + 0];
                    double tree_xmin_0p0 = connectivity->vertices[3*v_mmm_0p0 + 0];


                    // debugging code
                    double qx_0p0 = quad_0p0->x / (double) P4EST_ROOT_LEN + tree_xmin_0p0;
                    double qh_0p0=P4EST_QUADRANT_LEN(quad_0p0->level) / (double) P4EST_ROOT_LEN;
                    double d_0p0_p0=qx_0p0+qh_0p0-x;
                    double d_0p0_m0=x-qx_0p0;

                    bool p1_0p0=d_0p0_p0==this->max_distance;
                    bool p2_0p0=d_0p0_m0==this->max_distance;


                    //d_0p0_m0
                    if(x<quad_0p0->x / (double) P4EST_ROOT_LEN + tree_xmin_0p0)
                    {

                        this->neighbors[n].d_0p0_m0 += (double)this->max_distance;
                    }

                    //d_0p0_p0
                    if(quad_0p0->x / (double) P4EST_ROOT_LEN + tree_xmin_0p0+P4EST_QUADRANT_LEN(quad_0p0->level) / (double) P4EST_ROOT_LEN-x==this->max_distance)
                    {

                        this->neighbors[n].d_0p0_p0 = 0;
                    }

                    if( this->neighbors[n].d_0p0_p0 ==this->max_distance)
                    {
                ...
                //------------------------------------00m-------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_00m = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_00m_idx + 0];
                    double tree_xmin_00m = connectivity->vertices[3*v_00m + 0];
                    ...
                    // debugging code
                    double qx_00m = quad_00m->x / (double) P4EST_ROOT_LEN + tree_xmin_00m;
                    double qh_00m=P4EST_QUADRANT_LEN(quad_00m->level) / (double) P4EST_ROOT_LEN;
                    double d_00m_p0=qx_00m+qh_00m-x;
                    double d_00m_m0=x-qx_00m;

                    bool p1_00m=d_00m_p0==this->max_distance;
                    bool p2_00m=d_00m_m0==this->max_distance;
                    if(x<quad_00m->x / (double) P4EST_ROOT_LEN + tree_xmin_00m)
                    {
                        this->neighbors[n].d_00m_m0 += (double)this->max_distance;
                    }


                    //d00m_p0
                    if(quad_00m->x / (double) P4EST_ROOT_LEN + tree_xmin_00m+P4EST_QUADRANT_LEN(quad_00m->level) / (double) P4EST_ROOT_LEN-x==this->max_distance)
                    {
                        this->neighbors[n].d_00m_p0 = 0;
                    }

                    if(this->neighbors[n].d_00m_p0==this->max_distance)
                    {
                        this->neighbors[n].d_00m_p0 = 0;
                    }
                ...
                //------------------------------------00p-------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_00p = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_00p_idx + 0];
                    double tree_xmin_00p = connectivity->vertices[3*v_00p + 0];
                    ...
                    // debugging code
                    double qx_00p = quad_00p->x / (double) P4EST_ROOT_LEN + tree_xmin_00p;
                    double qh_00p=P4EST_QUADRANT_LEN(quad_00p->level) / (double) P4EST_ROOT_LEN;
                    double d_00p_p0=qx_00p+qh_00p-x;
                    double d_00p_m0=x-qx_00p;

                    bool p1_00p=d_00p_p0==this->max_distance;
                    bool p2_00p=d_00p_m0==this->max_distance;
                    if(x<quad_00p->x / (double) P4EST_ROOT_LEN + tree_xmin_00p)
                    {
                        this->neighbors[n].d_00p_m0 += (double)this->max_distance;
                    }


                    //d00m_p0
                    if(quad_00p->x / (double) P4EST_ROOT_LEN + tree_xmin_00p+P4EST_QUADRANT_LEN(quad_00p->level) / (double) P4EST_ROOT_LEN-x==this->max_distance)
                    {
                        this->neighbors[n].d_00p_p0 = 0;
                    }

                    if(this->neighbors[n].d_00p_p0==this->max_distance)
                    {
                        this->neighbors[n].d_00p_p0 = 0;
                    }
            ...
            if(this->py)
            {
                ...
                //------------------------------------m00--------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_mmm_m00 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_m00_idx + 0];
                    double tree_ymin_m00 = connectivity->vertices[3*v_mmm_m00 + 1];


                    // debugging code
                    double qy_m00 = quad_m00->y / (double) P4EST_ROOT_LEN + tree_ymin_m00;
                    double qh_m00=P4EST_QUADRANT_LEN(quad_m00->level) / (double) P4EST_ROOT_LEN;
                    double d_m00_p0=qy_m00+qh_m00-y;
                    double d_m00_m0=y-qy_m00;

                    bool p1_m00=d_m00_p0==this->max_distance;
                    bool p2_m00=d_m00_m0==this->max_distance;

                    if(y<quad_m00->y / (double) P4EST_ROOT_LEN + tree_ymin_m00)
                    {
                        this->neighbors[n].d_m00_m0 += (double)this->max_distance;
                    }

                    if(quad_m00->y / (double) P4EST_ROOT_LEN + tree_ymin_m00+P4EST_QUADRANT_LEN(quad_m00->level) / (double) P4EST_ROOT_LEN-y==this->max_distance)
                    {

                        this->neighbors[n].d_m00_p0 = 0;
                    }

                    if( this->neighbors[n].d_m00_p0==this->max_distance)
                    {
                ...
                //----------------------------------p00------------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_mmm_p00 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_p00_idx + 0];
                    double tree_ymin_p00 = connectivity->vertices[3*v_mmm_p00 + 1];
                    double qy_p00 = quad_p00->y / (double) P4EST_ROOT_LEN + tree_ymin_p00;
                    double qh_p00=P4EST_QUADRANT_LEN(quad_p00->level) / (double) P4EST_ROOT_LEN;
                    double d_p00_p0=qy_p00+qh_p00-y;
                    double d_p00_m0=y-qy_p00;

                    bool p1_p00=d_p00_p0==this->max_distance;
                    bool p2_p00=d_p00_m0==this->max_distance;


                    if(y<quad_p00->y / (double) P4EST_ROOT_LEN + tree_ymin_p00)
                    {
                        this->neighbors[n].d_p00_m0 += (double)this->max_distance;
                    }

                    if(quad_p00->y / (double) P4EST_ROOT_LEN + tree_ymin_p00+P4EST_QUADRANT_LEN(quad_p00->level) / (double) P4EST_ROOT_LEN-y==this->max_distance)
                    {

                        this->neighbors[n].d_p00_p0 = 0;
                    }

                    if(this->neighbors[n].d_p00_p0==this->max_distance)
                    {
                ...
                //------------------------------------00m--------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_mmm_00m = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_00m_idx + 0];
                    double tree_ymin_00m = connectivity->vertices[3*v_mmm_00m + 1];


                    // debugging code
                    double qy_00m = quad_00m->y / (double) P4EST_ROOT_LEN + tree_ymin_00m;
                    double qh_00m=P4EST_QUADRANT_LEN(quad_00m->level) / (double) P4EST_ROOT_LEN;
                    double d_00m_0p=qy_00m+qh_00m-y;
                    double d_00m_0m=y-qy_00m;

                    bool p1_00m=d_00m_0p==this->max_distance;
                    bool p2_00m=d_00m_0m==this->max_distance;

                    if(y<quad_00m->y / (double) P4EST_ROOT_LEN + tree_ymin_00m)
                    {
                        this->neighbors[n].d_00m_0m += (double)this->max_distance;
                    }

                    if(quad_00m->y / (double) P4EST_ROOT_LEN + tree_ymin_00m+P4EST_QUADRANT_LEN(quad_00m->level) / (double) P4EST_ROOT_LEN-y==this->max_distance)
                    {

                        this->neighbors[n].d_00m_0p = 0;
                    }

                    if( this->neighbors[n].d_00m_0p==this->max_distance)
                    {
                ...
                //----------------------------------00p------------------------------------------------------------//
                {
                    ...
                    p4est_topidx_t v_mmm_00p = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_00p_idx + 0];
                    double tree_ymin_00p = connectivity->vertices[3*v_mmm_00p + 1];
                    double qy_00p = quad_00p->y / (double) P4EST_ROOT_LEN + tree_ymin_00p;
                    double qh_00p=P4EST_QUADRANT_LEN(quad_00p->level) / (double) P4EST_ROOT_LEN;
                    double d_00p_0p=qy_00p+qh_00p-y;
                    double d_00p_0m=y-qy_00p;

                    bool p1_00p=d_00p_0p==this->max_distance;
                    bool p2_00p=d_00p_0m==this->max_distance;


                    if(y<quad_00p->y / (double) P4EST_ROOT_LEN + tree_ymin_00p)
                    {
                        this->neighbors[n].d_00p_0m += (double)this->max_distance;
                    }

                    if(quad_00p->y / (double) P4EST_ROOT_LEN + tree_ymin_00p+P4EST_QUADRANT_LEN(quad_00p->level) / (double) P4EST_ROOT_LEN-y==this->max_distance)
                    {
                        this->neighbors[n].d_00p_0p = 0;
                    }

                    if(this->neighbors[n].d_00p_0p==this->max_distance)
                    {
                        this->neighbors[n].d_00p_0p = 0;
                    }
                }
            ...
            if(this->pz)
            {
                    ...
                    //------------------------------------0m0--------------------------------------------------------//
                    {
                        ...
                        p4est_topidx_t v_mmm_0m0 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_0m0_idx + 0];
                        double tree_zmin_0m0 = connectivity->vertices[3*v_mmm_0m0 + 2];
                        ...
                        // debugging code
                        double qz_0m0 = quad_0m0->z / (double) P4EST_ROOT_LEN + tree_zmin_0m0;
                        double qh_0m0=P4EST_QUADRANT_LEN(quad_0m0->level) / (double) P4EST_ROOT_LEN;
                        double d_0m0_0p=qz_0m0+qh_0m0-z;
                        double d_0m0_0m=z-qz_0m0;

                        bool p1_0m0=d_0m0_0p==this->max_distance;
                        bool p2_0m0=d_0m0_0m==this->max_distance;
                        if(z<quad_0m0->z / (double) P4EST_ROOT_LEN + tree_zmin_0m0)
                        {
                            this->neighbors[n].d_0m0_0m += (double)this->max_distance;
                        }


                        //d0m0_0p
                        if(quad_0m0->z / (double) P4EST_ROOT_LEN + tree_zmin_0m0+P4EST_QUADRANT_LEN(quad_0m0->level) / (double) P4EST_ROOT_LEN-z==this->max_distance)
                        {
                            this->neighbors[n].d_0m0_0p = 0;
                        }

                        if(this->neighbors[n].d_0m0_0p==this->max_distance)
                        {
                            this->neighbors[n].d_0m0_0p = 0;
                        }
                    ...
                    {
                        p4est_topidx_t v_mmm_0p0 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_0p0_idx + 0];
                        double tree_zmin_0p0 = connectivity->vertices[3*v_mmm_0p0 + 2];


                        // debugging code
                        double qz_0p0 = quad_0p0->z / (double) P4EST_ROOT_LEN + tree_zmin_0p0;
                        double qh_0p0=P4EST_QUADRANT_LEN(quad_0p0->level) / (double) P4EST_ROOT_LEN;
                        double d_0p0_0p=qz_0p0+qh_0p0-z;
                        double d_0p0_0m=z-qz_0p0;

                        bool p1_0p0=d_0p0_0p==this->max_distance;
                        bool p2_0p0=d_0p0_0m==this->max_distance;


                        //d_0p0_0m
                        if(z<quad_0p0->z / (double) P4EST_ROOT_LEN + tree_zmin_0p0)
                        {

                            this->neighbors[n].d_0p0_0m += (double)this->max_distance;
                        }

                        //d_0p0_0p
                        if(quad_0p0->z / (double) P4EST_ROOT_LEN + tree_zmin_0p0+P4EST_QUADRANT_LEN(quad_0p0->level) / (double) P4EST_ROOT_LEN-z==this->max_distance)
                        {

                            this->neighbors[n].d_0p0_0p = 0;
                        }

                        if( this->neighbors[n].d_0p0_0p ==this->max_distance)
                        {
                    ...
                    //------------------------------------m00--------------------------------------------------------//
                    {
                        ...
                        p4est_topidx_t v_mmm_m00 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_m00_idx+0];
                        double tree_zmin_m00 = connectivity->vertices[3*v_mmm_m00 + 2];


                        // debugging code
                        double qz_m00 = quad_m00->z / (double) P4EST_ROOT_LEN + tree_zmin_m00;
                        double qh_m00=P4EST_QUADRANT_LEN(quad_m00->level) / (double) P4EST_ROOT_LEN;
                        double d_m00_0p=qz_m00+qh_m00-z;
                        double d_m00_0m=z-qz_m00;

                        bool p1_m00=d_m00_0m==this->max_distance;
                        bool p2_m00=d_m00_0p==this->max_distance;

                        if(z<quad_m00->z / (double) P4EST_ROOT_LEN + tree_zmin_m00)
                        {
                            this->neighbors[n].d_m00_0m += (double)this->max_distance;
                        }

                        if(quad_m00->z / (double) P4EST_ROOT_LEN + tree_zmin_m00+P4EST_QUADRANT_LEN(quad_m00->level) / (double) P4EST_ROOT_LEN-z==this->max_distance)
                        {

                            this->neighbors[n].d_m00_0p = 0;
                        }

                        if( this->neighbors[n].d_m00_0p==this->max_distance)
                        {
                    ...
                    //----------------------------------p00------------------------------------------------------------//
                    {
                        ...
                        p4est_topidx_t v_mmm_p00 = connectivity->tree_to_vertex[P4EST_CHILDREN*tree_p00_idx];
                        double tree_zmin_p00 = connectivity->vertices[3*v_mmm_p00 + 2];
                        double qz_p00 = quad_p00->z / (double) P4EST_ROOT_LEN + tree_zmin_p00;
                        double qh_p00=P4EST_QUADRANT_LEN(quad_p00->level) / (double) P4EST_ROOT_LEN;
                        double d_p00_0p=qz_p00+qh_p00-z;
                        double d_p00_0m=z-qz_p00;

                        bool p1_p00=d_p00_0p==this->max_distance;
                        bool p2_p00=d_p00_0m==this->max_distance;


                        if(z<quad_p00->z / (double) P4EST_ROOT_LEN + tree_zmin_p00)
                        {
                            if(n==13976)
                            {
                                std::cout<<n<<" "<< d_p00_0m<<" "<<this->neighbors[n].d_p00_0m <<std::endl;
                            }
                            this->neighbors[n].d_p00_0m += (double)this->max_distance;
                            d_p00_0m=this->neighbors[n].d_p00_0m ;
                            if(n==13976)
                            {
                                std::cout<<n<<" "<< d_p00_0m<<std::endl;
                            }

                        }

                        if(quad_p00->z / (double) P4EST_ROOT_LEN + tree_zmin_p00+P4EST_QUADRANT_LEN(quad_p00->level) / (double) P4EST_ROOT_LEN-z==this->max_distance)
                        {

                            this->neighbors[n].d_p00_0p = 0;
                        }

                        if(this->neighbors[n].d_p00_0p==this->max_distance)
                        {
...
#ifdef P4_TO_P8
void my_p4est_node_neighbors_t::dxx_and_dyy_central_using_block(const Vec f, Vec fxx, Vec fyy, Vec fzz) const
#else
