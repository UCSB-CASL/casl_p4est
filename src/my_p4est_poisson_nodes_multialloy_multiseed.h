...
class my_p4est_poisson_nodes_multialloy_t
{
  ...
  public:
    ...
    {
      ptr_->interp_.set_input(ptr_->c0_.vec, ptr_->c0_dd_.vec[0], ptr_->c0_dd_.vec[1], quadratic);
//      ptr_->interp_.set_input(ptr_->c0_.vec, linear);
      double c0 = ptr_->interp_(x, y);

      ptr_->interp_.set_input(ptr_->c0n_.vec, ptr_->c0n_dd_.vec[0], ptr_->c0n_dd_.vec[1], quadratic);
