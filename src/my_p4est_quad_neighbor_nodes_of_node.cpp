...
void quad_neighbor_nodes_of_node_t::x_ngbd_with_quadratic_interpolation_bs_one(const double *f[], double *f_m00, double *f_000, double *f_p00, const unsigned int &n_arrays) const
{
#ifdef CASL_LOG_TINY_EVENTS
  PetscErrorCode ierr_log_event = PetscLogEventBegin(log_quad_neighbor_nodes_of_node_t_x_ngbd_with_quadratic_interpolation, 0, 0, 0, 0); CHKERRXX(ierr_log_event);
#endif
...
void quad_neighbor_nodes_of_node_t::y_ngbd_with_quadratic_interpolation(const double *f[], double *f_0m0, double *f_000, double *f_0p0, const unsigned int &n_arrays, const unsigned int &bs) const
{
  P4EST_ASSERT(bs>1);
#ifdef CASL_LOG_TINY_EVENTS
...
void quad_neighbor_nodes_of_node_t::y_ngbd_with_quadratic_interpolation_bs_one(const double *f[], double *f_0m0, double *f_000, double *f_0p0, const unsigned int &n_arrays) const
{
#ifdef CASL_LOG_TINY_EVENTS
  PetscErrorCode ierr_log_event = PetscLogEventBegin(log_quad_neighbor_nodes_of_node_t_y_ngbd_with_quadratic_interpolation, 0, 0, 0, 0); CHKERRXX(ierr_log_event);
#endif
...
#ifdef P4_TO_P8
void quad_neighbor_nodes_of_node_t::z_ngbd_with_quadratic_interpolation(const double *f[], double *f_00m, double *f_000, double *f_00p, const unsigned int &n_arrays, const unsigned int &bs) const
{
  P4EST_ASSERT(bs>1);
#ifdef CASL_LOG_TINY_EVENTS
...
void quad_neighbor_nodes_of_node_t::z_ngbd_with_quadratic_interpolation_bs_one(const double *f[], double *f_00m, double *f_000, double *f_00p, const unsigned int &n_arrays) const
{
#ifdef CASL_LOG_TINY_EVENTS
  PetscErrorCode ierr_log_event = PetscLogEventBegin(log_quad_neighbor_nodes_of_node_t_z_ngbd_with_quadratic_interpolation, 0, 0, 0, 0); CHKERRXX(ierr_log_event);
#endif
