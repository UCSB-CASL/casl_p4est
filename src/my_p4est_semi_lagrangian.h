...
public:
  ...
  void update_p4est_second_order_from_last_grid(Vec vx, Vec vy, Vec vz, double dt, Vec &phi, Vec phi_xx = NULL, Vec phi_yy = NULL, Vec phi_zz = NULL);
  ...
  void update_p4est_second_order_from_last_grid(Vec vx_nm1, Vec vy_nm1, Vec vz_nm1,
                                                Vec vx_n  , Vec vy_n  , Vec vz_n,
                                                double dt_nm1, double dt_n,
                                                Vec &phi, Vec phi_xx = NULL, Vec phi_yy = NULL, Vec phi_zz = NULL);
#else
