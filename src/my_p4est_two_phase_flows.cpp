...
void my_p4est_two_phase_flows_t::jump_face_solver::solve(Vec *solution, const PetscBool &use_nonzero_initial_guess, const KSPType &ksp_type, const PCType &pc_type)
{
  PetscErrorCode ierr;
