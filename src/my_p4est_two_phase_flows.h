...
//  void TVD_extrapolation_of_np1_node_velocities(const u_int& niterations = 20, const u_char& order = 2);
  ...
  void build_sharp_temperature_np1(Vec sharp_temperature_np1) const;
...
//  void set_face_velocities_np1(CF_DIM* vnp1_m_[P4EST_DIM], CF_DIM* vnp1_p_[P4EST_DIM]);
  ...
  void get_average_velocity_in_domain(const char& sgn, double avg_velocity[P4EST_DIM], double* volume_in_domain = NULL, double* interface_area = NULL);
  ...
  static void build_initial_computational_grids(const mpi_environment_t &mpi, my_p4est_brick_t *brick, p4est_connectivity_t* connectivity,
                                                ...
                                                my_p4est_cell_neighbors_t* &ngbd_c, my_p4est_faces_t* &faces, Vec &phi_np1_computational_nodes, const bool& reinit_ls = false);
