...
//    int len1 = strlen(vtufilename);
//     int len2 = strlen(filename);


//     for(int i_printf=0;i_printf<len1;i_printf++)
//         std::cout<<vtufilename[i_printf];
//    std::cout<< std::endl;
//     for(int i_printf=0;i_printf<len2;i_printf++)
//         std::cout<<filename[i_printf];
//    std::cout<< std::endl;
