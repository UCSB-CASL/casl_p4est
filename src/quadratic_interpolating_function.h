#ifndef QUADRATIC_INTERPOLATING_FUNCTION_H
#define QUADRATIC_INTERPOLATING_FUNCTION_H
...
enum interpolation_type{
  ...
  nonoscilatory_interpolation
};
}

class QuadraticInterpolatingFunction: public CF_2
{
  interpolation_type inter_type_;
...
public:
  QuadraticInterpolatingFunction(p4est_t *p4est, p4est_nodes_t *nodes, p4est_ghost_t *ghost,
  ...
  void set_interpolation_type(interpolation_type type);
...
#endif // QUADRATIC_INTERPOLATING_FUNCTION_H
