...
void simplex2_mls_t::do_action(int cn, action_t action, double p0, double p1, double p2)
{
  /* Interpolate values to all vertices */
  interpolate_all(p0, p1, p2);
...
double simplex2_mls_t::measure_of_domain()
{
  double result = 0.0;
...
double simplex2_mls_t::integrate_over_interface(int num, double f0, double f1, double f2)
{
  ...
  for (int i = 0; i < edgs.size(); i++)
  {
    ...
    if (!e->is_split && e->loc == FCE)
      if (!integrate_specific || (integrate_specific && e->c0 == num))
...
double simplex2_mls_t::measure_of_interface(int num)
{
  bool integrate_specific = (num != -1);
  double result = 0.0;
...
double simplex2_mls_t::integrate_over_colored_interface(int num0, int num1, double f0, double f1, double f2)
{
  /* interpolate function values to vertices */
  interpolate_all(f0, f1, f2);
...
double simplex2_mls_t::measure_of_colored_interface(int num0, int num1)
{
  double result = 0.0;
...
double simplex2_mls_t::integrate_over_intersection(int num0, int num1, double f0, double f1, double f2)
{
  double result = 0.0;
...
double simplex2_mls_t::integrate_in_dir(int dir, double f0, double f1, double f2)
{
  /* interpolate function values to vertices */
  interpolate_all(f0, f1, f2);
...
double simplex2_mls_t::measure_in_dir(int dir)
{
  double result = 0.0;
